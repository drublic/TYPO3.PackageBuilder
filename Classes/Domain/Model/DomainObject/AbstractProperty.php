...
abstract class AbstractProperty {
	...
	public function isAnyToManyRelation() {
		return is_subclass_of($this, 'TYPO3\\PackageBuilder\\Domain\\Model\\DomainObject\\Relation\\AnyToManyRelation');
	}
	...
	public function isRelation() {
		return is_subclass_of($this, 'TYPO3\\PackageBuilder\\Domain\\Model\\DomainObject\\Relation\\AbstractRelation');
	}
	...
	public function isBoolean() {
		return is_a($this, 'TYPO3\\PackageBuilder\\Domain\\Model\\DomainObject\\BooleanProperty');
	}
	...
	public function getDataType() {
		return substr(get_class($this), strlen('TYPO3\\PackageBuilder\\Domain\\Model\\DomainObject_'));
	}
