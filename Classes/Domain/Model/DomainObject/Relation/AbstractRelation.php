 ...
 ***************************************************************/
namespace TYPO3\PackageBuilder\Domain\Model\DomainObject\Relation;
 ...
 * @version $ID:$
 */
abstract class AbstractRelation extends \TYPO3\PackageBuilder\Domain\Model\DomainObject\AbstractProperty {
	...
	/**
	 * @param \TYPO3\PackageBuilder\Domain\Model\DomainObject $foreignClass Set the foreign class of the relation
	 */
	public function setForeignModel(\TYPO3\PackageBuilder\Domain\Model\DomainObject $foreignClass) {
