...
class ClassBuilder {
	...
	/**
	 * @var TYPO3\PackageBuilder\Service\FLOW3\RoundTrip
	 *
	 */
	protected $roundTripService;

	/**
	 * @var TYPO3\PackageBuilder\Configuration\FLOW3\ConfigurationManager
	 */
	...
	/**
	 *
	 * @var TYPO3\PackageBuilder\Service\FLOW3\CodeGenerator
	 */
